            ...
            <main class="py-10 px-8 relative">
                ...
                <section class="modern-card rounded-2xl overflow-hidden slide-up shadow-sm max-w-4xl mx-auto">
                    ...
                    <form action="<?= BASEURL; ?>/User/edit" method="POST" class="p-8" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <div class="px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                            <?= $data['user']['role_id'] == 1 ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' ?>">
                        ...
                        <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-100" onclick="window.history.back()">
                            <span
                               class="px-6 py-2 text-gray-700 hover:text-gray-900 font-medium cursor-pointer">
                                Batal
                            </span>
                            <button type="submit"
                                    class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl hover-scale transition-all"  onclick="window.history.back()">
                                Simpan Perubahan
                            </button>
                        </div>
                    </form>
