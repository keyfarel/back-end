...
<div class="flex min-h-screen">
    <!-- Sidebar -->
    <?php include_once '../../public/assets/components/sidebar.php'; ?>
    ...
    <main class="flex-1 ml-64 p-8">
        <div class="max-w-7xl mx-auto">
            ...
            <header class="mb-8">
                ...
                <p class="mt-1 text-sm text-gray-500">Welcome back, <?php echo htmlspecialchars($_SESSION['username']); ?></p>
            </header>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr class="table-row">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">Researcher</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
        ...
        <!-- Add logout button -->
        <form action="/App/controllers/authcontroller.php" method="POST" class="absolute top-4 right-4">
