        ...
        <main class="py-10 px-8">
            ...
            <div class="max-w-7xl mx-auto mb-12 flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Selamat datang kembali, User</p>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <img src="/isFor-Website/App/public/assets/images/coding-image.png" alt="User Profile" class="w-12 h-12 rounded-full">
                </div>
            </div>
